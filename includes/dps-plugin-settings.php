...
?>
	...
	data-custom="<?php echo esc_attr( $args['dps_custom_data'] ); ?>"
	name="dps_options[<?php echo esc_attr( $args['label_for'] ); ?>]" >
...
<input type="text" id="<?php echo esc_attr( $args['label_for'] ); ?>"
	data-lorem="<?php echo esc_attr( $args['dps_custom_data'] ); ?>"
	name="dps_options[<?php echo esc_attr( $args['label_for'] ); ?>]" value="<?=(isset($options[ $args['label_for'] ]) ? $options[ $args['label_for'] ] : '')?>">
